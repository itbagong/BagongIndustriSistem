        ...
        <div class="modal-content" style="background:#fff; border-radius:12px; width:100%; max-width:520px; margin:auto;">
            ...
            <div class="modal-body">
                <form id="religionForm" method="POST" action="">
                    <?= csrf_field() ?>
                    <input type="hidden" id="religionId" name="id">

                    <div class="form-group">
                        <label>Nama <span class="required">*</span></label>
                        <input type="text" class="form-control" id="religionName" name="name" placeholder="contoh: Permanen, PKWT, Trainee">
