...
<?= $this->section('content') ?>
        ...
        <div class="modal-content" style="background:#fff; border-radius:12px; width:100%; max-width:520px; margin:auto;">
            ...
            <div class="modal-body">
                <form id="genderForm" method="POST" action="">
                    <?= csrf_field() ?>
                    <input type="hidden" id="oldGenderId" name="old_id">

                    <div class="form-group">
                        <label>ID <span class="required">*</span></label>
                        <input type="text" class="form-control" id="genderId" name="id" placeholder="GNDR-BDM-...">
                        <div id="idError" style="color:#dc3545; font-size:.85em; margin-top:4px; display:none;"></div>
                    </div>

                    <div class="form-group">
                        <label>Nama <span class="required">*</span></label>
                        <input type="text" class="form-control" id="genderName" name="name" placeholder="contoh: Laki - Laki, Perempuan...">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const oldGenderId         = document.getElementById('oldGenderId');
        ...
        document.querySelectorAll('.btn-edit').forEach(function (btn) {
            btn.addEventListener('click', function () {
                ...
                oldGenderId.value              = this.dataset.id;
        ...
        document.getElementById('btnSaveGenderModal').addEventListener('click', function () {
            ...
            genderForm.appendChild(aliasInput);
