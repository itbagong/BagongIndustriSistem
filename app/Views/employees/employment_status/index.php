...
<?= $this->section('content') ?>
        ...
        <main class="content">
            ...
            <div class="page-header">
                <div class="page-title">
                    ...
                    <h1>Manajemen Employment Status</h1>
                </div>
            ...
            <div class="table-card">
                <div class="table-header">
                    <h3>Daftar Employment Status</h3>
                    ...
                    <table class="employee-table">
                        ...
                        <tbody>
                            <?php if (!empty($employmentStatuses)): ?>
                                <?php foreach ($employmentStatuses as $i => $es):
                                    $isDeleted = (
                                        $es['is_deleted'] === true ||
                                        $es['is_deleted'] === 't'  ||
                                        $es['is_deleted'] === '1'  ||
    ...
    <div id="esModal" style="display:none; position:fixed; inset:0; background:rgba(0,0,0,.5); z-index:9999; align-items:center; justify-content:center;">
        <div class="modal-content" style="background:#fff; border-radius:12px; width:100%; max-width:520px; margin:auto;">
            <div class="modal-header">
                <h2 id="esModalTitle">➕ Tambah Employment Status</h2>
            ...
            <div class="modal-body">
                <form id="esForm" method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="esId" name="id" placeholder="EMTS-BDM-...">
                        <div id="idError" style="color:#dc3545; font-size:.85em; margin-top:4px; display:none;"></div>
                    </div>

                    <div class="form-group">
                        <label>Nama <span class="required">*</span></label>
                        <input type="text" class="form-control" id="esName" name="name" placeholder="contoh: Aktif, Withdrawn...">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.getElementById('btnTambah').addEventListener('click', function () {
            esTitle.textContent     = '➕ Tambah Employment Status';
            oldEsId.value              = '';
            esId.value              = '';
            esName.value            = '';
            currentAliases             = [];
            renderAliasList();
            esForm.action           = BASE_URL + 'employees/employment-status/store';
        ...
        document.querySelectorAll('.btn-edit').forEach(function (btn) {
            btn.addEventListener('click', function () {
                esTitle.textContent     = '✏️ Edit Employment Status';
                ...
                esForm.action           = BASE_URL + 'employees/employment-status/update/' + this.dataset.id;
                nameError.style.display = 'none';
                showModal(esModal);
            });
        });
        ...
        document.querySelectorAll('.btn-toggle').forEach(function (btn) {
            btn.addEventListener('click', function () {
                toggleForm.action      = BASE_URL + 'employees/employment-status/toggle/' + this.dataset.id;
