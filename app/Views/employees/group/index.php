            ...
            <div class="stats-summary">
                ...
                <div class="stat-box">
                    ...
                    <div class="content">
                        <h4>Aktif</h4>
                        <div class="value">
                            <?= count(array_filter($groups, fn($es) => !($es['is_deleted'] === true || $es['is_deleted'] === 't' || $es['is_deleted'] === '1' || $es['is_deleted'] === 1))) ?>
                        </div>
                    </div>
                </div>
                <div class="stat-box">
            ...
            <div class="table-card">
                <div class="table-header">
                    ...
                    <div class="table-info">
                        Menampilkan <strong><?= count($groups) ?></strong> dari <strong><?= $pager->getTotal() ?></strong> data
                    </div>
                </div>
            ...
            <div class="modal-body">
                <form id="groupForm" method="POST" action="">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="groupName" name="name" placeholder="contoh: Permanen, PKWT, Trainee">
