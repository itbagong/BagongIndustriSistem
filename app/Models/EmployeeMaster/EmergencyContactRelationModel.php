...
class EmergencyContactRelationModel extends Model
{
    protected $DBGroup    = 'pg';
    protected $table      = 'emergency_contact_relations';
    ...
    /**
     * Generate next ID in format ECR-BDM-XXXX
     */
    public function generateId(): string
    {
        ...
        return 'ECR-BDM-' . str_pad($num + 1, 4, '0', STR_PAD_LEFT);
    }
