...
class GenderController extends BaseController
{
    ...
    public function index(): string
    {
        ...
        $genders = $this->model->paginate($perPage);

        // Decode Postgres text[] → PHP array for each row
        $genders = array_map(function ($row) {
        ...
        return view('employees/gender/index', $data);
    }
    ...
    {
        $rules = [
            'id'          => 'required|regex_match[/^GNDR-BDM-.+/]',
        ...
        return redirect()->to(base_url('employees/gender'))->with('success', 'Gender berhasil ditambahkan.');
    }
    ...
    public function update(string $id)
    {
        ...
        try{
            ...
            return redirect()->back()->withInput()
                            ->with('error', 'Gagal memperbarui gender: ' . $e->getMessage());
        }

        return redirect()->to(base_url('employees/gender'))->with('success', 'Gender berhasil diperbarui.');
    }
    ...
    public function toggleStatus(string $id)
    {
        ...
        return redirect()->to(base_url('employees/gender'))->with('success', 'Status Gender berhasil diperbarui.');
    }
}